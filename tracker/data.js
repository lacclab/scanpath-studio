 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "",
    "**What's left.** Everything — this is the **bump half only**. Per the user",
    "(2026-08-07) the work was split in two: *this* item lands the version move and the",
    "breaking-change verification below, and the feature-adoption pass is now",
    "**ENG-36**. Keeping them apart means the bump stays small and revertible instead",
    "of being swamped by a long adoption list.",
    "",
    "**Background (technical).**",
    "",
