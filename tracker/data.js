 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "",
    "**What's left. Everything after the inventory — this item is NOT finished.**",
    "The epic is scoped by the user as one sweeping branch that lands finished and",
    "gets beta-tested, so it was deliberately not started half-way in a session that",
    "was delivering seven other items: an incomplete sweep is the single worst state",
    "for a change whose diff nobody reads. Concretely still to do: agree the target",
