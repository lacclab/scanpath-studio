...
window.TRACKER = {
 ...
 "items": [
  ...
  },
  {
   ...
   "status": "Review",
   "note": "Implemented 2026-08-10 on eng-28-simplification — shared render contract, acyclic core data ownership, selective archaeology cleanup, full gates green; awaiting beta-test",
   "date": "2026-08-10",
   "added": "2026-08-04",
   "group": "Engineering",
   "subgroup": "Code quality",
   ...
   "body": [
    ...
    "",
    "**What's left.** User beta-test and sign-off. The item is intentionally in **Review**,",
    "not Closed; no implementation or automated gate remains. If beta-testing finds a",
    "behavior regression, fix it on the same `eng-28-simplification` branch before approval.",
    "",
