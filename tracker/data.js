...
window.TRACKER = {
 ...
 "items": [
  ...
  },
  {
   ...
   "status": "Backlog",
   "note": "large staged data-model epic",
   "date": "",
   "added": "2026-08-11",
   "group": "Datasets & ingestion",
   "subgroup": "",
   ...
   "decisions": [
    "In the main scanpath view, should a multipart trial default to one screen with previous/next navigation, a stitched overview, or offer both with one chosen default?",
    "Are fixation index and timestamp global across the parent trial, reset within each screen, or should the canonical model retain both global and screen-local versions?",
    "Should favorites/tags/notes attach to the parent trial only, to individual screens, or support both scopes with separate UI?",
    "For a full-trial animation/export, should screen transitions be instantaneous, include recorded inter-screen time when available, or let the user choose?"
   ]
  },
  {
   "id": "BUG-22",
  ...
  },
  {
   ...
   "decisions": [
    "Should use-case tutorials only point and instruct, or may an explicit **Show me / Open this panel** action safely navigate views and open controls while never changing data, filters, annotations, or scientific settings?"
   ]
  },
  {
   "id": "UX-41",
