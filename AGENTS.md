...
├─ wizard_shell.py   DATA-22 + UX-53: the wizard's **two**-step registry (`STEPS`: data · mapping), keyed-expander accordion, the `section()` line-title used for the former steps 2–7, progress chips and navigation (no column/frame knowledge)
