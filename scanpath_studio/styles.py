...
def get_app_css() -> str:
    ...
    /* Remove all whitespace around charts. Spatial scanpath/heatmap/animation
       plots are embedded as a fixed-size SVG/HTML in an iframe (stIFrame); the
       research charts render via st.pyplot (stPyplot). */
    div[data-testid="stIFrame"], div[data-testid="stPyplot"] {margin: 0 !important; padding: 0 !important; line-height: 0 !important;}
    div[data-testid="stIFrame"] iframe, div[data-testid="stPyplot"] img {display: block !important; margin: 0 !important; padding: 0 !important;}
    /* Target parent containers */
    div[data-testid="stVerticalBlock"] > div:has(> div[data-testid="stIFrame"]),
    div[data-testid="stVerticalBlock"] > div:has(> div[data-testid="stPyplot"]) {padding: 0 !important; margin: 0 !important; gap: 0 !important;}
    div[data-testid="element-container"]:has(> div[data-testid="stIFrame"]),
    div[data-testid="element-container"]:has(> div[data-testid="stPyplot"]) {margin: 0 !important; padding: 0 !important;}
    ...
    div[data-testid="stMarkdown"] + div[data-testid="element-container"]:has(div[data-testid="stIFrame"]) {margin-top: 0 !important;}
    div[data-testid="element-container"]:has(div[data-testid="stIFrame"]) + div[data-testid="stExpander"] {margin-top: 0.5rem !important;}
    ...
    div[data-testid="stIFrame"], div[data-testid="stPyplot"], div[data-testid="element-container"], .stMarkdown, .element-container {
        animation: none !important;
        transition: none !important;
    }
    div[data-testid="stIFrame"] *, div[data-testid="stPyplot"] * {
        animation: none !important;
        transition: none !important;
    }
