 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "",
    "**What's left.** Nothing essential. Left the \"other polish worth a look\"",
    "ideas from the Background below (side-by-side Frame-every/Max-frames",
    "columns, Autoplay next to Playback speed, folding the frame-count caption",
    "into the info box) as follow-up ideas rather than in scope here.",
    "",
