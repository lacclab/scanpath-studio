 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "stays consistent. Streamlit widget labels render as plain text by default;",
    "bolding needs `label_visibility`/markdown styling or",
    "`st.markdown(\"**Select Trial**\")` placed above the selectbox instead of",
    "using its native `label=`. The composite-trial-id picker",
