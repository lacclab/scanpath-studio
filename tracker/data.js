...
window.TRACKER = {
 ...
 "items": [
  ...
  },
  {
   ...
   "decisions": [
    "Should a newly entered stimulus begin with no fixations (the user clicks to add them), or keep today's one-default-fixation-per-word starting point?",
    "When a fixation is dragged onto another word, should `word_id` automatically follow the containing/nearest word, or should target word and X/Y remain independent until the table is edited?"
   ]
  },
  {
   "id": "VIZ-34",
  ...
  },
  {
   ...
   "body": [
    ...
    "forcing all three exporters into one oversized implementation.",
    "",
    "Implementation plan:",
    "",
