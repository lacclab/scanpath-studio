 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "A per-run memo keyed on frame identity would collapse it to ~9 ms, but it",
    "needs care: an `id()`-keyed memo must hold a strong reference (or ids get",
    "reused) and must be cleared each run, and it re-opens a within-run variant of",
    "audit finding **S5** if a frame is ever mutated in place. Not attempted here.",
    ...
    "it is worth remembering when adding one.",
    "",
