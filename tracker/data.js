 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "",
    "**What's left.** The verdict — **keep as-is**: it's a legitimate",
    "generic-when-present feature, not OneStop-specific in practice, now with",
    "the false-positive fixed. Worth reviewing that verdict, and whether the",
    "narrow 0/1-constant edge case above is worth chasing further.",
    "",
