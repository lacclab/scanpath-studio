 ...
 "items": [
  ...
  },
  {
   ...
   "body": [
    ...
    "",
    "**What's left.** The user's review, and one thing only verifiable *after* a",
    ...
    "floor is 88 against a real 90, i.e. ~2 points of slack. That is deliberate",
    "(a floor, not a target — it should catch a real drop without turning every PR",
    "into a coverage negotiation), but it is the kind of number worth disagreeing",
    "with. `app.py` (79%) and `cli.py` (82%) remain the thinnest real modules; both",
    "are mostly Streamlit render paths and argparse branches, and neither was worth",
    "chasing for the number alone.",
    "",
