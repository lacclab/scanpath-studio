...
| **Data** | *Set up your dataset* — the data source and where its files are, the column mapping, paginated word / fixation / raw-gaze tables (CSV + Parquet download), summary statistics, the recording setup, and the optional preprocessing pass. |
