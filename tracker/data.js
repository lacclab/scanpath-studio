...
window.TRACKER = {
 ...
 "items": [
  ...
  },
  {
   ...
   "status": "In progress",
   "note": "implemented 2026-08-02; back to In progress 2026-08-03 with CMP-6's revision round",
   "date": "2026-08-03",
   "group": "Compare mode",
   "subgroup": "",
   "archived": false,
   "body": [
    "> **In progress.** Implemented 2026-08-02; moved back with **CMP-6** on",
    "> 2026-08-03 (the user's compare-mode feedback round) — no gap of its own has",
    "> been named yet, so the work below stands as shipped.",
    "",
    ...
    "",
    "**What's left.** Nothing named yet — the item rides CMP-6's revision round",
    "(2026-08-03) awaiting any further compare-mode feedback. Whatever **CMP-8**",
  ...
  },
  {
   ...
   "status": "In progress",
   "note": "core shipped 2026-08-02; 2026-08-03 — move the Order-by picker to the END of the row",
   "date": "2026-08-03",
   "group": "Compare mode",
   "subgroup": "",
   "archived": false,
   "body": [
    "> **In progress.** Core shipped 2026-08-02; user feedback 2026-08-03: the",
    "> **Order by** selectbox must sit at the **end** of the picker row (after the",
    "> ◀ ▶ step buttons), not lead it — see *What's left*.",
    "",
    ...
    "([`tabs._render_compare_selector`](scanpath_studio/tabs.py:825)) gained a leading",
    "**Order by** selectbox (key `single_compare_order`, shown when there are >2",
    ...
    "**What's left.**",
    "",
    "- **Move the Order by selectbox to the END of the picker row** (user feedback",
    "  2026-08-03) — it currently leads the row (leftmost column); it should render",
    "  last, after the trial-id selectbox, the scrubbing slider and the ◀ ▶ step",
    "  buttons. Note the render-order subtlety: the widget must still *execute*",
    "  before the selectbox/slider (its value reorders the list they show), so keep",
    "  filling its column out of visual order — create the columns first, render the",
    "  ordering widget into the last one, then fill the earlier columns.",
    "- Regression rate / reading *speed* (per-word normalization) orderings — they",
